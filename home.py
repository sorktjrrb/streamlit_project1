...
def run_home():
    st.markdown("### <span style='color: black;'>Microsoft의 주식 가격을 가지고 분석 및 학습하여 향후 주식 가격을 예측하는 앱입니다.</span>", unsafe_allow_html=True)
    ...
    st.markdown("### 기능 소개")
    st.markdown("<strong>이 앱은 Microsoft의 주식 가격 데이터를 사용하여 다음과 같은 기능을 제공합니다.</strong>", unsafe_allow_html=True)
